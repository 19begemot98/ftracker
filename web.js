...
(function ($) {
    var $$;
    (function ($$) {
        class $my_ftracker_group_exercise_card extends $.$my_ftracker_group_exercise_card {
            exercise_name(next) { return next ?? ''; }
            click_uri(next) { return next ?? ''; }
        }
        $$.$my_ftracker_group_exercise_card = $my_ftracker_group_exercise_card;
        class $my_ftracker_group extends $.$my_ftracker_group {
            group_id() {
            ...
            exercises() {
                ...
                const id = (this.group_id() || 'chest');
                return map[id].map(name => $.$my_ftracker_group_exercise_card.make({
        ...
        __decorate([
            $mol_mem
        ], $my_ftracker_group.prototype, "group_id", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_group.prototype, "group_title", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_group.prototype, "exercises", null);
        $$.$my_ftracker_group = $my_ftracker_group;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
var $;
(function ($) {
    $mol_style_attach("my/ftracker/group/group.view.css", "[my_ftracker_group] {\n\tbackground: transparent;\n\tpadding: 0;\n}\n\n[my_ftracker_group_title] {\n\tcolor: #00695c;\n\tfont-size: 1.8rem;\n\tfont-weight: 600;\n\ttext-align: center;\n\tmargin-bottom: 30px;\n\tpadding: 20px;\n\tbackground: rgba(255, 255, 255, 0.9);\n\tborder-radius: 16px;\n\tbox-shadow: 0 4px 16px rgba(128, 203, 196, 0.2);\n\tmargin: 20px;\n}\n\n[my_ftracker_group_Exercises] {\n\tdisplay: grid;\n\tgap: 16px;\n\tpadding: 0 20px;\n}\n\n[my_ftracker_group_exercise_card] {\n\ttext-decoration: none;\n}\n\n[my_ftracker_group_exercise_card_Card] {\n\tbackground: rgba(255, 255, 255, 0.95);\n\tborder-radius: 16px;\n\tpadding: 24px;\n\ttransition: all 0.3s ease;\n\tborder: 2px solid rgba(178, 235, 242, 0.5);\n\tbox-shadow: 0 4px 12px rgba(128, 203, 196, 0.15);\n}\n\n[my_ftracker_group_exercise_card_Card]:hover {\n\ttransform: translateY(-3px);\n\tbox-shadow: 0 8px 25px rgba(128, 203, 196, 0.25);\n\tborder-color: #4db6ac;\n\tbackground: rgba(255, 255, 255, 1);\n}\n\n[my_ftracker_group_exercise_card_Title] {\n\tcolor: #37474f;\n\tfont-size: 1.3rem;\n\tfont-weight: 500;\n\ttext-align: center;\n\tmargin: 0;\n}\n\n@media (max-width: 768px) {\n\t[my_ftracker_group_title] {\n\t\tfont-size: 1.5rem;\n\t\tpadding: 16px;\n\t\tmargin: 16px;\n\t}\n\n\t[my_ftracker_group_Exercises] {\n\t\tpadding: 0 16px;\n\t\tgap: 12px;\n\t}\n\n\t[my_ftracker_group_exercise_card_Card] {\n\t\tpadding: 20px;\n\t\tborder-radius: 12px;\n\t}\n\n\t[my_ftracker_group_exercise_card_Title] {\n\t\tfont-size: 1.1rem;\n\t}\n}\n");
})($ || ($ = {}));
...
(function ($) {
    var $$;
    (function ($$) {
        class $my_ftracker_workout_group_link extends $.$my_ftracker_workout_group_link {
        }
        $$.$my_ftracker_workout_group_link = $my_ftracker_workout_group_link;
        class $my_ftracker_workout extends $.$my_ftracker_workout {
            group_id(next) {
        ...
        __decorate([
            $mol_mem
        ], $my_ftracker_workout.prototype, "group_id", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_workout.prototype, "groups", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_workout.prototype, "page_id", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_workout.prototype, "sub", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_workout.prototype, "Group_page", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_workout.prototype, "Groups", null);
        $$.$my_ftracker_workout = $my_ftracker_workout;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
var $;
(function ($) {
    $mol_style_attach("my/ftracker/workout/workout.view.css", "[my_ftracker_workout_Groups] {\n\tdisplay: grid;\n\tgrid-template-columns: repeat(auto-fit, minmax(250px, 1fr));\n\tgap: 20px;\n\tpadding: 10px;\n}\n\n[my_ftracker_workout_group_link] [mol_link] {\n\tbackground: rgba(255, 255, 255, 0.95);\n\tborder: 2px solid rgba(178, 235, 242, 0.6);\n\tborder-radius: 16px;\n\tpadding: 30px 20px;\n\ttransition: all 0.3s ease;\n\ttext-decoration: none;\n\tdisplay: block;\n\ttext-align: center;\n}\n\n[my_ftracker_workout_group_link] [mol_link]:hover {\n\tborder-color: #4db6ac;\n\ttransform: translateY(-3px);\n\tbox-shadow: 0 8px 20px rgba(128, 203, 196, 0.2);\n}\n\n[my_ftracker_workout_group_link_title] {\n\tcolor: #4db6ac;\n\tfont-size: 1.5rem;\n\tfont-weight: 600;\n}\n\n@media (max-width: 768px) {\n \t[my_ftracker_workout_Groups] {\n\t\tgrid-template-columns: repeat(auto-fit, minmax(200px, 1fr));\n\t\tgap: 16px;\n\t\tpadding: 8px;\n\t}\n\n\t[my_ftracker_workout_group_link] [mol_link] {\n\t\tpadding: 24px 16px;\n\t\tborder-radius: 12px;\n\t}\n\n\t[my_ftracker_workout_group_link_title] {\n\t\tfont-size: 1.3rem;\n\t}\n}\n");
})($ || ($ = {}));
...
(function ($) {
    var $$;
    (function ($$) {
        class $my_ftracker_history extends $.$my_ftracker_history {
            history_list(next) {
                if (next)
                    return next;
            ...
            history_items() {
                ...
                return data.map((item) => $mol_labeler.make({
                    title: () => item.sets_done
        ...
        __decorate([
            $mol_mem
        ], $my_ftracker_history.prototype, "history_list", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_history.prototype, "history_items", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_history.prototype, "clear_history_click", null);
        $$.$my_ftracker_history = $my_ftracker_history;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
var $;
(function ($) {
    $mol_style_attach("my/ftracker/history/history.view.css", "[my_ftracker_history] {\n\tbackground: rgba(255, 255, 255, 0.95);\n\tborder-radius: 20px;\n\tpadding: 32px;\n\tbox-shadow: 0 8px 25px rgba(0, 0, 0, 0.08);\n\tmargin: 24px;\n\tborder: 1px solid rgba(178, 235, 242, 0.3);\n\tmin-height: 500px;\n}\n[my_ftracker_history_title] {\n\tcolor: #00695c;\n\tfont-size: 1.8rem;\n\tfont-weight: 600;\n\ttext-align: center;\n\tmargin-bottom: 4px;\n\tpadding: 20px;\n\tbackground: rgba(255, 255, 255, 0.9);\n\tborder-radius: 16px;\n\tbox-shadow: 0 4px 16px rgba(128, 203, 196, 0.2);\n}\n\n[my_ftracker_history_History_list] {\n\tdisplay: flex;\n\tflex-direction: column;\n\tgap: 16px;\n\tmargin-bottom: 30px;\n\tmin-height: 300px;\n}\n\n[my_ftracker_history_History_list] [mol_labeler] {\n\tbackground: rgba(255, 255, 255, 0.9);\n\tborder-radius: 12px;\n\tpadding: 20px;\n\tborder-left: 3px solid #4db6ac;\n\tbox-shadow: 0 2px 6px rgba(128, 203, 196, 0.1);\n\ttransition: all 0.3s ease;\n}\n\n[my_ftracker_history_History_list] [mol_labeler]:hover {\n\ttransform: translateY(-2px);\n\tbox-shadow: 0 4px 15px rgba(128, 203, 196, 0.25);\n\tborder-left-color: #26a69a;\n}\n\n[my_ftracker_history_History_list] [mol_labeler_title] {\n\tcolor: #37474f;\n\tfont-size: 1.1rem;\n\tfont-weight: 500;\n\tline-height: 1.4;\n\tmargin: 0;\n}\n\n[my_ftracker_history_History_list] [mol_labeler]:first-child [mol_labeler_title] {\n\tcolor: #546e7a;\n\tfont-style: italic;\n\ttext-align: center;\n\tpadding: 40px 20px;\n\tbackground: rgba(248, 251, 252, 0.8);\n\tborder-radius: 12px;\n\tborder-left: 4px solid #b2ebf2;\n\tfont-size: 1.2rem;\n}\n\n[my_ftracker_history_Clear_button] {\n\tbackground: linear-gradient(135deg, #80cbc4, #b2dfdb);\n\tcolor: #004d40;\n\tborder: none;\n\tborder-radius: 25px;\n\tpadding: 16px 32px;\n\tfont-weight: 600;\n\tfont-size: 1.1rem;\n\tcursor: pointer;\n\ttransition: all 0.3s ease;\n\tbox-shadow: 0 4px 16px rgba(128, 203, 196, 0.3);\n\tmargin: 20px auto;\n\tdisplay: block;\n\tborder: 1px solid #80cbc4;\n}\n\n[my_ftracker_history_Clear_button]:hover {\n\tbackground: linear-gradient(135deg, #4db6ac, #80cbc4);\n\ttransform: translateY(-2px);\n\tbox-shadow: 0 6px 22px rgba(128, 203, 196, 0.5);\n\tcolor: #00695c;\n}\n\n\n[my_ftracker_history_item] {\n\tbackground: rgba(255, 255, 255, 0.95);\n\tborder-radius: 12px;\n\tpadding: 18px;\n\tmargin-bottom: 12px;\n\tborder-left: 4px solid #4db6ac;\n\tbox-shadow: 0 2px 8px rgba(128, 203, 196, 0.15);\n\ttransition: all 0.3s ease;\n}\n\n[my_ftracker_history_item]:hover {\n\ttransform: translateY(-2px);\n\tbox-shadow: 0 4px 15px rgba(128, 203, 196, 0.25);\n\tborder-left-color: #26a69a;\n}\n\n[my_ftracker_history_item_title] {\n\tcolor: #37474f;\n\tfont-size: 1rem;\n\tfont-weight: 500;\n\tline-height: 1.4;\n\tmargin: 0;\n}\n\n\n@media (max-width: 768px) {\n\t[my_ftracker_history] {\n\t\tpadding: 20px;\n\t\tmargin: 16px;\n\t}\n\t\n\t[my_ftracker_history_title] {\n\t\tfont-size: 1.6rem;\n\t\tpadding: 16px;\n\t\tmargin-bottom: 30px;\n\t}\n\t\n\t[my_ftracker_history_History_list] [mol_labeler_title] {\n\t\tfont-size: 1rem;\n\t}\n\t\n\t[my_ftracker_history_Clear_button] {\n\t\tpadding: 14px 28px;\n\t\tfont-size: 1rem;\n\t}\n}\n");
})($ || ($ = {}));
...
(function ($) {
    var $$;
    (function ($$) {
        class $my_ftracker_exercise extends $.$my_ftracker_exercise {
            Exercise_Data_Map = {
                'Жим лёжа': {
            ...
            exercise_description() {
                ...
                const data = this.Exercise_Data_Map[name];
            ...
            exercise_image_uri() {
                const name = this.exercise_name();
                return this.Exercise_Image_Map[name] || 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=300&h=200&fit=crop';
            }
            timer_seconds(next) {
                return next ?? 0;
            }
        ...
        __decorate([
            $mol_mem
        ], $my_ftracker_exercise.prototype, "exercise_name", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_exercise.prototype, "exercise_title", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_exercise.prototype, "exercise_description", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_exercise.prototype, "exercise_sets_info", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_exercise.prototype, "exercise_reps_info", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_exercise.prototype, "exercise_time_info", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_exercise.prototype, "exercise_rest_info", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_exercise.prototype, "exercise_image_uri", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_exercise.prototype, "timer_seconds", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_exercise.prototype, "timer_running", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_exercise.prototype, "timer_button_click", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_exercise.prototype, "timer_reset_click", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_exercise.prototype, "set_count", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_exercise.prototype, "increment_set_click", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_exercise.prototype, "reset_counter_click", null);
        __decorate([
            $mol_mem
        ], $my_ftracker_exercise.prototype, "finish_exercise_click", null);
        $$.$my_ftracker_exercise = $my_ftracker_exercise;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
var $;
(function ($) {
    $mol_style_attach("my/ftracker/exercise/exercise.view.css", "[my_ftracker_exercise] {\n\tbackground: rgba(255, 255, 255, 0.95);\n\tborder-radius: 60px;\n\tpadding: 32px;\n\tbox-shadow: 0 8px 25px rgba(0, 0, 0, 0.08);\n\tmargin: 10px;\n\tborder: 1px solid rgba(178, 235, 242, 0.4);\n}\n\n[my_ftracker_exercise_title] {\n\tcolor: #00695c;\n\tfont-size: 1.8rem;\n\tfont-weight: 600;\n\ttext-align: center;\n\tmargin-bottom: 30px;\n\tpadding: 20px;\n\tbackground: rgba(255, 255, 255, 0.9);\n\tborder-radius: 16px;\n\tbox-shadow: 0 4px 16px rgba(128, 203, 196, 0.2);\n}\n\n[my_ftracker_exercise_Exercise_Image] {\n\tborder-radius: 16px;\n\tbox-shadow: 0 6px 20px rgba(128, 203, 196, 0.2);\n\tmargin-bottom: 30px;\n\tborder: 2px solid rgba(178, 235, 242, 0.6);\n}\n\n[my_ftracker_exercise_Exercise_Details] {\n\tbackground: rgba(248, 251, 252, 0.8);\n\tborder-radius: 16px;\n\tpadding: 25px;\n\tmargin-bottom: 25px;\n\tborder: 1px solid rgba(178, 235, 242, 0.4);\n}\n\n[my_ftracker_exercise_Description_Title] {\n\tcolor: #4db6ac;\n\tfont-size: 1.3rem;\n\tfont-weight: 600;\n\tmargin-bottom: 15px;\n}\n\n[my_ftracker_exercise_Description_Text] {\n\tcolor: #546e7a;\n\tfont-size: 1.1rem;\n\tline-height: 1.6;\n\tmargin: 0;\n}\n\n[my_ftracker_exercise_Recommendations_Title] {\n\tcolor: #4db6ac;\n\tfont-size: 1.3rem;\n\tfont-weight: 600;\n\tmargin-bottom: 20px;\n\ttext-align: center;\n\tpadding: 15px;\n\tbackground: rgba(255, 255, 255, 0.9);\n\tborder-radius: 12px;\n\tbox-shadow: 0 2px 10px rgba(128, 203, 196, 0.15);\n}\n\n[my_ftracker_exercise_Sets_Info],\n[my_ftracker_exercise_Reps_Info],\n[my_ftracker_exercise_Time_Info],\n[my_ftracker_exercise_Rest_Info] {\n\tbackground: rgba(255, 255, 255, 0.9);\n\tborder-radius: 12px;\n\tpadding: 18px;\n\tmargin-bottom: 15px;\n\tborder-left: 4px solid #4db6ac;\n\tbox-shadow: 0 2px 8px rgba(128, 203, 196, 0.1);\n}\n\n[my_ftracker_exercise_Sets_Info] [mol_labeler_title],\n[my_ftracker_exercise_Reps_Info] [mol_labeler_title],\n[my_ftracker_exercise_Time_Info] [mol_labeler_title],\n[my_ftracker_exercise_Rest_Info] [mol_labeler_title] {\n\tcolor: #00695c;\n\tfont-weight: 600;\n\tmargin-bottom: 8px;\n\tfont-size: 1.1rem;\n}\n\n[my_ftracker_exercise_Sets_Info_Text],\n[my_ftracker_exercise_Reps_Info_Text],\n[my_ftracker_exercise_Time_Info_Text],\n[my_ftracker_exercise_Rest_Info_Text] {\n\tcolor: #546e7a;\n\tfont-size: 1rem;\n\tmargin: 0;\n}\n\n[my_ftracker_exercise_Timer_block],\n[my_ftracker_exercise_Counter_block] {\n\tbackground: rgba(248, 251, 252, 0.8);\n\tborder-radius: 16px;\n\tpadding: 25px;\n\tmargin-bottom: 25px;\n\tborder: 1px solid rgba(178, 235, 242, 0.4);\n}\n\n[my_ftracker_exercise_Timer_title],\n[my_ftracker_exercise_Counter_title] {\n\tcolor: #4db6ac;\n\tfont-size: 1.3rem;\n\tfont-weight: 600;\n\tmargin-bottom: 20px;\n\ttext-align: center;\n}\n\n[my_ftracker_exercise_Timer_row],\n[my_ftracker_exercise_Counter_row] {\n\tdisplay: flex;\n\tjustify-content: center;\n\talign-items: center;\n\tgap: 20px;\n\tflex-wrap: wrap;\n}\n\n[my_ftracker_exercise_Timer_label] {\n\tcolor: #00695c;\n\tfont-size: 2.5rem;\n\tfont-weight: 600;\n\tfont-family: 'Courier New', monospace;\n\tbackground: rgba(255, 255, 255, 0.9);\n\tpadding: 15px 25px;\n\tborder-radius: 12px;\n\tbox-shadow: 0 4px 12px rgba(128, 203, 196, 0.2);\n\tmin-width: 120px;\n\ttext-align: center;\n}\n\n[my_ftracker_exercise_Timer_controls],\n[my_ftracker_exercise_Counter_buttons] {\n\tdisplay: flex;\n\tgap: 12px;\n\tflex-wrap: wrap;\n\tjustify-content: center;\n}\n\n[my_ftracker_exercise_Start_pause],\n[my_ftracker_exercise_Reset_timer],\n[my_ftracker_exercise_Big_plus],\n[my_ftracker_exercise_Reset_counter] {\n\tbackground: linear-gradient(135deg, #80cbc4, #b2dfdb);\n\tcolor: #004d40;\n\tborder: none;\n\tborder-radius: 25px;\n\tpadding: 12px 24px;\n\tfont-weight: 500;\n\tcursor: pointer;\n\ttransition: all 0.3s ease;\n\tbox-shadow: 0 4px 12px rgba(128, 203, 196, 0.3);\n\tfont-size: 1rem;\n\tborder: 1px solid #80cbc4;\n}\n\n[my_ftracker_exercise_Start_pause]:hover,\n[my_ftracker_exercise_Reset_timer]:hover,\n[my_ftracker_exercise_Big_plus]:hover,\n[my_ftracker_exercise_Reset_counter]:hover {\n\tbackground: linear-gradient(135deg, #4db6ac, #80cbc4);\n\ttransform: translateY(-2px);\n\tbox-shadow: 0 6px 18px rgba(128, 203, 196, 0.4);\n\tcolor: #00695c;\n}\n\n[my_ftracker_exercise_Big_counter] {\n\tcolor: #00695c;\n\tfont-size: 3rem;\n\tfont-weight: 700;\n\tbackground: rgba(255, 255, 255, 0.9);\n\tpadding: 20px 30px;\n\tborder-radius: 16px;\n\tbox-shadow: 0 6px 15px rgba(128, 203, 196, 0.25);\n\tmin-width: 100px;\n\ttext-align: center;\n\tmargin: 0 20px;\n}\n\n[my_ftracker_exercise_Finish_row] {\n\tdisplay: flex;\n\tjustify-content: center;\n\tmargin-top: 30px;\n}\n\n[my_ftracker_exercise_Finish] {\n\tbackground: linear-gradient(135deg, #26a69a, #4db6ac);\n\tcolor: white;\n\tborder: none;\n\tborder-radius: 28px;\n\tpadding: 18px 36px;\n\tfont-weight: 600;\n\tfont-size: 1.2rem;\n\tcursor: pointer;\n\ttransition: all 0.3s ease;\n\tbox-shadow: 0 6px 20px rgba(38, 166, 154, 0.4);\n\tborder: 1px solid #26a69a;\n}\n\n[my_ftracker_exercise_Finish]:hover {\n\tbackground: linear-gradient(135deg, #00897b, #26a69a);\n\ttransform: translateY(-3px);\n\tbox-shadow: 0 8px 25px rgba(38, 166, 154, 0.5);\n}\n\n@media (max-width: 768px) {\n\t[my_ftracker_exercise] {\n\t\tborder-radius: 30px;\n\t\tpadding: 20px;\n\t\tmargin: 8px;\n\t}\n\t\n\t[my_ftracker_exercise_title] {\n\t\tfont-size: 1.5rem;\n\t\tpadding: 15px;\n\t}\n\t\n\t[my_ftracker_exercise_Big_counter] {\n\t\tfont-size: 2rem;\n\t\tpadding: 15px 20px;\n\t}\n\t\n\t[my_ftracker_exercise_Timer_label] {\n\t\tfont-size: 1.8rem;\n\t\tpadding: 12px 20px;\n\t}\n}\n");
})($ || ($ = {}));
...
(function ($) {
    var $$;
    (function ($$) {
        class $my_ftracker extends $.$my_ftracker {
            page_id(next) {
        ...
        __decorate([
            $mol_mem
        ], $my_ftracker.prototype, "page_id", null);
        __decorate([
            $mol_mem
        ], $my_ftracker.prototype, "workout_uri", null);
        __decorate([
            $mol_mem
        ], $my_ftracker.prototype, "history_uri", null);
        __decorate([
            $mol_mem
        ], $my_ftracker.prototype, "Current_page", null);
        $$.$my_ftracker = $my_ftracker;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
var $;
(function ($) {
    $mol_style_attach("my/ftracker/ftracker.view.css", "[my_ftracker] {\n\t--mol_theme_surface: linear-gradient(135deg, #e0f7fa 0%, #b2ebf2 50%, #80cbc4 100%);\n\t--mol_theme_content_bg: rgba(255, 255, 255, 0.95);\n\t--mol_theme_field_bg: rgba(178, 235, 242, 0.3);\n\t\n\t--mol_theme_text: #37474f;\n\t--mol_theme_text_mild: #546e7a;\n\t--mol_theme_text_lowest: #90a4ae;\n\t\n\t--mol_theme_control: #4db6ac;\n\t--mol_theme_control_hover: #26a69a;\n\t\n\t--mol_theme_major: #80cbc4;\n\t--mol_theme_major_text: #ffffff;\n\t\n\t--mol_theme_line: rgba(178, 235, 242, 0.6);\n\t--mol_theme_shadow: 0 8px 25px rgba(0, 0, 0, 0.08);\n\t\n\t--mol_gap_round: 16px;\n\t--mol_gap: 20px;\n}\n\n[my_ftracker] > [mol_page_body] {\n\tbackground: var(--mol_theme_surface);\n\tmin-height: 100vh;\n\tpadding: 0;\n}\n\n[my_ftracker_title] {\n\tpadding: 28px var(--mol_gap);\n\tbackground: linear-gradient(135deg, #b2ebf2, #80cbc4);\n\tcolor: #00695c;\n\tfont-size: 2.1rem;\n\tfont-weight: 600;\n\ttext-align: center;\n\tmargin: 0;\n\tborder: none;\n\tletter-spacing: 1px;\n}\n\n[my_ftracker_Nav] {\n\tbackground: rgba(255, 255, 255, 0.85);\n\tdisplay: flex;\n\tmargin: 0;\n}\n\n[my_ftracker_Nav] [mol_list_row] {\n\tflex: 1;\n\tmargin: 0;\n}\n\n[my_ftracker_Nav] [mol_link] {\n\tdisplay: flex;\n\talign-items: center;\n\tjustify-content: center;\n\theight: 65px;\n\tcolor: var(--mol_theme_text);\n\tfont-weight: 500;\n\tfont-size: 1.2rem;\n\ttransition: all 0.3s ease;\n\tbackground: transparent;\n\ttext-decoration: none;\n}\n\n[my_ftracker_Nav] [mol_link].mol_link_current {\n\tcolor: #00695c;\n\tbackground: rgba(128, 203, 196, 0.2);\n\tborder-bottom: 3px solid #4db6ac;\n}\n\n[my_ftracker_Nav] [mol_link]:hover {\n\tcolor: #00695c;\n\tbackground: rgba(128, 203, 196, 0.1);\n}\n\n[my_ftracker_Current_page] {\n\tbackground: transparent;\n\tpadding: 0;\n\tmargin: 0;\n}\n\n[my_ftracker_workout],\n[my_ftracker_history],\n[my_ftracker_exercise] {\n\tbackground: var(--mol_theme_content_bg);\n\tborder-radius: 20px;\n\tpadding: 32px;\n\tbox-shadow: var(--mol_theme_shadow);\n\tmargin: 24px;\n\tmin-height: 420px;\n\tborder: 1px solid rgba(178, 235, 242, 0.4);\n}\n\n[mol_button] {\n\tbackground: linear-gradient(135deg, #80cbc4, #b2dfdb);\n\tcolor: #004d40;\n\tborder: none;\n\tborder-radius: 28px;\n\tpadding: 15px 30px;\n\tfont-weight: 500;\n\tcursor: pointer;\n\ttransition: all 0.3s ease;\n\tbox-shadow: 0 4px 16px rgba(128, 203, 196, 0.3);\n\tfont-size: 1.05rem;\n\tborder: 1px solid #80cbc4;\n}\n\n[mol_button]:hover {\n\tbackground: linear-gradient(135deg, #4db6ac, #80cbc4);\n\ttransform: translateY(-2px);\n\tbox-shadow: 0 6px 22px rgba(128, 203, 196, 0.5);\n\tcolor: #00695c;\n}\n\n[mol_button_major] {\n\tbackground: linear-gradient(135deg, #26a69a, #4db6ac);\n\tcolor: white;\n\tbox-shadow: 0 4px 16px rgba(38, 166, 154, 0.4);\n\tborder: 1px solid #26a69a;\n}\n\n[mol_button_major]:hover {\n\tbackground: linear-gradient(135deg, #00897b, #26a69a);\n\tbox-shadow: 0 6px 22px rgba(38, 166, 154, 0.6);\n}\n\n@media (max-width: 768px) {\n\t[my_ftracker_title] {\n\t\tfont-size: 1.6rem;\n\t\tpadding: 20px 16px;\n\t}\n\n\t[my_ftracker_Nav] [mol_link] {\n\t\theight: 55px;\n\t\tfont-size: 1rem;\n\t}\n\n\t[my_ftracker_workout],\n\t[my_ftracker_history],\n\t[my_ftracker_exercise] {\n\t\tpadding: 20px;\n\t\tmargin: 16px;\n\t\tborder-radius: 16px;\n\t}\n\n\t[mol_button] {\n\t\tpadding: 12px 24px;\n\t\tborder-radius: 20px;\n\t\tfont-size: 1rem;\n\t}\n}\n\n");
})($ || ($ = {}));
